...
<main
	class="h-screen place-items-center overflow-hidden bg-white px-8 py-48 text-[#333333] sm:grid sm:px-12 sm:py-0 xl:px-0"
>
	<section class="mx-auto place-items-center space-y-12 sm:grid sm:w-1/2 lg:w-1/3">
